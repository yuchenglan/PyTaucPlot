...
#plt.scatter(1239.8 / x, (y * 1239.8 / x)**2, marker = 'x', label='x = 2.00') #Ca$_2$MnWO$_6$') # n = 1/2, direct allowed, 2.30 eV') # nm -> eV: 1239.8 / x
...
#save figure
plt.savefig('3_A60S-1_042622_UV.png', dpi=500)
plt.savefig('3_A60S-1_042622_UV.pdf', dpi=500)
